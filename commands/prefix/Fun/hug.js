...
module.exports = {
    config: {
        name: "hug", // Name of Command
        description: "hug buat lu yang kesepian", // Command Description
        usage: "pap hug" // Command usage
    },
    ...
    if (!member) return message.channel.send("siape yang mau lu peluk?");
    let HugEmbed = new Discord.EmbedBuilder()
      .setTitle(
        `${message.author.username} kau tidak bisa memeluk dirimu sendiri tapi kalo mau sini gw peluk aja`
      )
